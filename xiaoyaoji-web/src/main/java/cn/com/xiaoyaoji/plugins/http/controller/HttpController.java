package cn.com.xiaoyaoji.plugins.http.controller;

import cn.com.xiaoyaoji.data.bean.Doc;
import cn.com.xiaoyaoji.plugins.http.service.HttpService;
...
public class HttpController {
    @GetMapping("{docId}")
    public ModelAndView get(@PathVariable String docId){
        Doc doc = HttpService.instance().getDoc(docId);
